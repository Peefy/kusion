...
build-all: build-local-darwin-all build-local-ubuntu-all build-local-centos-all build-local-darwin-arm64-all build-local-windows-all ## build-local-windows-all ## Build all platforms (darwin, linux, windows)
